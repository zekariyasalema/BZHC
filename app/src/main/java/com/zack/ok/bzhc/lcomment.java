...
public class lcomment extends AppCompatActivity implements View.OnClickListener {
    final String TAG = "lcomment";
    EditText etEmail,etFullName,etContactno,etMessage ;
    Button btnRegister;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lcomment);
            ...
            PostResponseAsyncTask task1 = new PostResponseAsyncTask(this,
                ...
                public void processFinish(String s) {
                    ...
                    if (s.contains("ErrorInsert")) {
                        Toast.makeText(lcomment.this,
                                getString(R.string.swnetwrong),
                                Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(lcomment.this,
                                getString(R.string.commsentsucss),
                                Toast.LENGTH_LONG).show();
