...
public class lcontactus extends AppCompatActivity implements View.OnClickListener {
    final String TAG = "lcontactus";
    EditText etEmail,etFullName,etContactno,etMessage ;
    Button btnRegister;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lcontactus);
    ...
    public void onClick(View v) {
        if (!emptyValidate(etFullName, etContactno, etMessage, etEmail)) {
            ...
            PostResponseAsyncTask task1 = new PostResponseAsyncTask(this,
                ...
                public void processFinish(String s) {
                    ...
                    if (s.contains("ErrorInsert")) {
                        Toast.makeText(lcontactus.this,
                                getString(R.string.smntwentwrogn),
                                Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(lcontactus.this,
                                getString(R.string.msgsented),
                                Toast.LENGTH_LONG).show();
            ...
            task1.execute("http://10.0.2.2:8082/BZHC/Android/includes/contactus.php");
